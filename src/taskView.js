...
export function renderTasks() {
  ...
  tasksToRender.forEach((task) => {
    ...
    dueDate.textContent = format(new Date(task.dueDate), "MMM d");
    ...
    taskRow.append(done, title, dueDate, status, deleteBtn);
...
function showTaskDetails(task) {
  ...
  detailsDate.textContent = `Due: ${format(new Date(task.dueDate), "MMMM d, yyyy")}`;

  detailsPriority.textContent = `Priority: ${task.priority}`;
